...
export default function Gasto({ gasto }) {
    ...
    return (
        <SwipeableList >
            ...
            >
                <div className="w-full max-h-24 flex items-center bg-slate-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm p-3 ">
                    ...
                    <div className='flex justify-end items-center w-full'>
                        <p className="text-white text-xl max-[640px]:text-base font-bold text-center">-{formatearCantidad(gasto.cantidad)}
                            <br />
                            <span className="font-semibold text-sm max-[640px]:text-sm text-white">{formatearFecha(gasto.fecha)}</span>
                        </p>
                    </div>
